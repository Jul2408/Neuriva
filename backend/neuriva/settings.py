"""
Django settings for NEURIVA project.
"""
...
WSGI_APPLICATION = 'neuriva.wsgi.application'
...
SIMPLE_JWT = {
    ...
    'REFRESH_TOKEN_LIFETIME': timedelta(days=config('JWT_REFRESH_TOKEN_LIFETIME', default=365, cast=int)),
